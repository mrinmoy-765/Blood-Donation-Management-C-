...
namespace This__SUCKS___
{
    public partial class Form9 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select Id,Name,Fname,Mname,Dob,Gender ,Age,MblNo,Email,BG,CrntCity,Permntadrs from SgnUpTab where Bg=@BG", con);
            cmd.Parameters.AddWithValue("BG", comboBox1.Text);
